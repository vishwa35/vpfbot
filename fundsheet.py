...
def getPFundUpdate(client):
  ...
  # Get Fund Sheets
  pfspreadsheet = client.open("Phoenician Fund")
  fund = pfspreadsheet.get_worksheet(3)
  week2week = pfspreadsheet.get_worksheet(4)
